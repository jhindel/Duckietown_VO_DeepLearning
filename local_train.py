...
from src.main import hyperparamter_tuning, training_testing, training_testing2
...
if __name__ == '__main__':
    ...
    args ={"data_dir":"/Users/julia/Documents/UNI/Master/Montréal/AV/project/duckietown_visual_odometry/data/",
           "model":"ConvNet", "train_split": train, "val_split": val, "test_split": test,
    ...
    training_testing2(args, wandb_project="deepvo-lightning-trials", visualization=True, wandb_name="trial_runs")
